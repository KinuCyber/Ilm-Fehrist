# Ilm Fehrist DESIGN.md

The README.md was getting bloated with fehrist philosophy and design
This separate DESIGN.md contains the detailed design and its philosophy
